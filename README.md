...
Experiment num| User number K | The number of communication users Ck | Communication period T | The number of labeled samples in server Ns | The non-iidness R | Neural network model
--- | --- | --- | --- | --- | --- | ---
0 |  10 | 10  | 16  | 1000  | 1.0 | ResNet-18 with GN
