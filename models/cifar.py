    ...
    if not os.path.isdir('../data/binary_cifar/'):
        ...
        for t in data.keys():
            for s in ['train','test']:
                ...
                torch.save(data[t][s]['x'], os.path.join(os.path.expanduser('../data/binary_cifar'),'data'+str(t)+s+'x.bin'))
                torch.save(data[t][s]['y'], os.path.join(os.path.expanduser('../data/binary_cifar'),'data'+str(t)+s+'y.bin'))
